...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("", dateStrToDigit("vsdf февраля 1993"))
        assertEquals("", dateStrToDigit("29 февраля sdg"))
        assertEquals("", dateStrToDigit("29 февраля 5464100"))
        assertEquals("29.02.4863600", dateStrToDigit("29 февраля 4863600"))
    }
    ...
    fun dateDigitToStr() {
        ...
        assertEquals("29 февраля 9630000", dateDigitToStr("29.02.9630000"))
    }
    ...
    fun flattenPhoneNumber() {
        ...
        assertEquals("", flattenPhoneNumber("+    (921)12738"))
        assertEquals("", flattenPhoneNumber("+7(921)"))
        assertEquals("", flattenPhoneNumber("9   )"))
    }
    ...
    fun firstDuplicateIndex() {
        ...
        assertEquals(-1, firstDuplicateIndex("a v a"))
    ...
    fun mostExpensive() {
        ...
        assertEquals("", mostExpensive("Хлеб 39.9; Молоко 62.5; ; Конфеты 89.9"))
