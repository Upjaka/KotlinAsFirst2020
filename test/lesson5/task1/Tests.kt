...
class Tests {
    ...
    fun averageStockPrice() {
        ...
        assertEquals(
            mapOf("MSFT" to 200.0, "NFLX" to 45.0, "" to 0.0),
            averageStockPrice(listOf("MSFT" to 100.0, "MSFT" to 200.0, "NFLX" to 40.0, "NFLX" to 50.0,
                "MSFT" to 300.0, "" to 0.0))
        )
    }
    ...
    fun findCheapestStuff() {
        ...
        assertEquals(
            "",
            findCheapestStuff(mapOf("" to ("" to 1.7976931348623157e+308)), "")
        )
    }
    ...
    fun canBuildFrom() {
        ...
        assertTrue(canBuildFrom(listOf('a', 'e'), "a"))
    ...
    fun hasAnagrams() {
        ...
        assertTrue(hasAnagrams(listOf("лунь", "пара", "море", "нуль")))
    }
